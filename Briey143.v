...
module Briey (
  ...
  reg        [22:0]   axi_sdramCtrl_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_addr;
  ...
  Axi4SharedArbiter_2 axi_sdramCtrl_io_axi_arbiter (
    ...
    .io_readInputs_0_ar_payload_addr        (_zz_84[22:0]                                                         ), //i
    ...
    .io_readInputs_1_ar_payload_addr        (_zz_86[22:0]                                                         ), //i
    ...
    .io_sharedInputs_0_arw_payload_addr     (_zz_88[22:0]                                                         ), //i
  ...
  assign _zz_84 = axi4ReadOnlyDecoder_2_io_outputs_2_ar_payload_addr[22:0];
  assign _zz_37[1 : 0] = 2'b00;
  assign _zz_85 = 3'b010;
  assign _zz_86 = axi_vgaCtrl_io_axi_decoder_io_outputs_0_ar_payload_addr[22:0];
  assign _zz_38[1 : 0] = 2'b00;
  assign _zz_87 = 2'b01;
  assign _zz_88 = axi4SharedDecoder_1_io_sharedOutputs_2_arw_payload_addr[22:0];
...
module Axi4SharedSdramCtrl (
  ...
  SdramCtrl ctrl (
    ...
    .io_bus_cmd_payload_address         (_zz_3[20:0]                              ), //i
  ...
  assign _zz_3 = bridge_axiCmd_payload_fragment_addr[22 : 2];
...
module SdramCtrl (
  ...
  reg        [10:0]   frontend_rsp_m2sPipe_rData_rowColumn;
  ...
  assign frontend_address_column = _zz_2[7 : 0];
  assign frontend_address_bank = _zz_2[9 : 8];
  assign frontend_address_row = _zz_2[20 : 10];
  always @ (*) begin
      ...
      if(bubbleInserter_cmd_valid)begin
        case(bubbleInserter_cmd_payload_task)
          ...
          default : begin
            if(bubbleInserter_cmd_ready)begin
              if((bubbleInserter_cmd_payload_bank == 2'b00))begin
                if((bubbleInserter_timings_banks_0_precharge_counter <= 3'b101))begin
                  bubbleInserter_timings_banks_0_precharge_counter <= 3'b101;
                end
              end
              if((bubbleInserter_cmd_payload_bank == 2'b01))begin
                if((bubbleInserter_timings_banks_1_precharge_counter <= 3'b101))begin
                  bubbleInserter_timings_banks_1_precharge_counter <= 3'b101;
                end
              end
              if((bubbleInserter_cmd_payload_bank == 2'b10))begin
                if((bubbleInserter_timings_banks_2_precharge_counter <= 3'b101))begin
                  bubbleInserter_timings_banks_2_precharge_counter <= 3'b101;
                end
              end
              if((bubbleInserter_cmd_payload_bank == 2'b11))begin
                if((bubbleInserter_timings_banks_3_precharge_counter <= 3'b101))begin
  ...
  always @ (posedge io_axiClk) begin
    ...
    if(chip_remoteCke)begin
      ...
      chip_sdram_DQM[2] <= _zz_17;
      chip_sdram_DQM[3] <= _zz_17;
